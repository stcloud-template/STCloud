...
- Source Metadata Path：`sources/azure/mysql_flexible_server_audit_log_connection_activated/metadata.json`
- Source Code Path：`sources/azure/mysql_flexible_server_audit_log_connection_activated/check.py`
