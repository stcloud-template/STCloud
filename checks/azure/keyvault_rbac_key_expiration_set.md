...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `keyvault_rbac_key_expiration_set` |
| クラウドプラットフォーム | Azure |
| サービス | keyvault |
| 重大度 | high |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/azure/keyvault_rbac_key_expiration_set/metadata.json](../../sources/azure/keyvault_rbac_key_expiration_set/metadata.json)
- Source Code：[sources/azure/keyvault_rbac_key_expiration_set/check.py](../../sources/azure/keyvault_rbac_key_expiration_set/check.py)
- Source Metadata Path：`sources/azure/keyvault_rbac_key_expiration_set/metadata.json`
- Source Code Path：`sources/azure/keyvault_rbac_key_expiration_set/check.py`
