...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `cosmosdb_account_use_aad_and_rbac` |
| クラウドプラットフォーム | Azure |
| サービス | cosmosdb |
| 重大度 | medium |
| カテゴリ | Uncategorized |
...
- 推奨リンク：[https://learn.microsoft.com/en-us/azure/cosmos-db/role-based-access-control](https://learn.microsoft.com/en-us/azure/cosmos-db/role-based-access-control)
