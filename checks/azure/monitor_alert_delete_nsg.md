...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `monitor_alert_delete_nsg` |
| クラウドプラットフォーム | Azure |
| サービス | monitor |
| 重大度 | high |
| カテゴリ | Uncategorized |
...
[https://www.trendmicro.com/cloudoneconformity-staging/knowledge-base/azure/ActivityLog/delete-network-security-group-rule-alert-in-use.html#trendmicro](https://www.trendmicro.com/cloudoneconformity-staging/knowledge-base/azure/ActivityLog/delete-network-security-group-rule-alert-in-use.html#trendmicro)
...
- Source Metadata：[sources/azure/monitor_alert_delete_nsg/metadata.json](../../sources/azure/monitor_alert_delete_nsg/metadata.json)
- Source Code：[sources/azure/monitor_alert_delete_nsg/check.py](../../sources/azure/monitor_alert_delete_nsg/check.py)
- Source Metadata Path：`sources/azure/monitor_alert_delete_nsg/metadata.json`
- Source Code Path：`sources/azure/monitor_alert_delete_nsg/check.py`
