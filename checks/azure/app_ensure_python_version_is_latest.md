...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `app_ensure_python_version_is_latest` |
| 云平台 | Azure |
| 服务 | app |
| 严重等级 | low |
| 类别 | Uncategorized |
...
- 推荐链接：[https://learn.microsoft.com/en-us/azure/app-service/configure-language-python#configure-python-version](https://learn.microsoft.com/en-us/azure/app-service/configure-language-python#configure-python-version)
