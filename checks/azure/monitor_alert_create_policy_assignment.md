...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `monitor_alert_create_policy_assignment` |
| クラウドプラットフォーム | Azure |
| サービス | monitor |
| 重大度 | high |
| カテゴリ | Uncategorized |
...
- 推奨リンク：[https://docs.microsoft.com/en-in/azure/azure-monitor/platform/alerts-activity-log](https://docs.microsoft.com/en-in/azure/azure-monitor/platform/alerts-activity-log)
