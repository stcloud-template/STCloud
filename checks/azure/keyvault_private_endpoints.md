...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `keyvault_private_endpoints` |
| クラウドプラットフォーム | Azure |
| サービス | keyvault |
| 重大度 | high |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/azure/keyvault_private_endpoints/metadata.json](../../sources/azure/keyvault_private_endpoints/metadata.json)
- Source Code：[sources/azure/keyvault_private_endpoints/check.py](../../sources/azure/keyvault_private_endpoints/check.py)
- Source Metadata Path：`sources/azure/keyvault_private_endpoints/metadata.json`
- Source Code Path：`sources/azure/keyvault_private_endpoints/check.py`
