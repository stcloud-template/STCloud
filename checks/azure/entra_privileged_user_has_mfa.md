...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `entra_privileged_user_has_mfa` |
| クラウドプラットフォーム | Azure |
| サービス | entra |
| 重大度 | high |
| カテゴリ | Uncategorized |
...
[https://www.trendmicro.com/cloudoneconformity/knowledge-base/azure/ActiveDirectory/multi-factor-authentication-for-all-privileged-users.html#](https://www.trendmicro.com/cloudoneconformity/knowledge-base/azure/ActiveDirectory/multi-factor-authentication-for-all-privileged-users.html#)
...
- Source Metadata：[sources/azure/entra_privileged_user_has_mfa/metadata.json](../../sources/azure/entra_privileged_user_has_mfa/metadata.json)
- Source Code：[sources/azure/entra_privileged_user_has_mfa/check.py](../../sources/azure/entra_privileged_user_has_mfa/check.py)
- Source Metadata Path：`sources/azure/entra_privileged_user_has_mfa/metadata.json`
- Source Code Path：`sources/azure/entra_privileged_user_has_mfa/check.py`
