...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `aks_clusters_public_access_disabled` |
| 云平台 | Azure |
| 服务 | aks |
| 严重等级 | high |
| 类别 | Uncategorized |
...
- 推荐链接：[https://learn.microsoft.com/en-us/azure/aks/access-private-cluster?tabs=azure-cli](https://learn.microsoft.com/en-us/azure/aks/access-private-cluster?tabs=azure-cli)
