...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `entra_policy_guest_invite_only_for_admin_roles` |
| クラウドプラットフォーム | Azure |
| サービス | entra |
| 重大度 | medium |
| カテゴリ | Uncategorized |
...
- 推奨リンク：[https://learn.microsoft.com/en-us/answers/questions/685101/how-to-allow-only-admins-to-add-guests](https://learn.microsoft.com/en-us/answers/questions/685101/how-to-allow-only-admins-to-add-guests)
