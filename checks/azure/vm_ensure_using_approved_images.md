...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `vm_ensure_using_approved_images` |
| 云平台 | Azure |
| 服务 | vm |
| 子服务 | image |
| 严重等级 | medium |
| 类别 | Uncategorized |
| 资源类型 | Microsoft.Compute/images |
| 资源组 | compute |
...
- 推荐链接：[https://docs.microsoft.com/en-us/azure/virtual-machines/windows/create-vm-generalized-managed](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/create-vm-generalized-managed)
