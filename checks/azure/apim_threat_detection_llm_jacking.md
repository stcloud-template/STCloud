...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `apim_threat_detection_llm_jacking` |
| クラウドプラットフォーム | Azure |
| サービス | apim |
| 重大度 | high |
| カテゴリ | threat-detection, monitoring, logging |
| リソースタイプ | Azure API Management Instance |
...
- 推奨リンク：[https://learn.microsoft.com/en-us/azure/api-management/monitor-api-management](https://learn.microsoft.com/en-us/azure/api-management/monitor-api-management)
