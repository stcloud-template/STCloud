...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `iam_customer_unattached_policy_no_administrative_privileges` |
| クラウドプラットフォーム | AWS |
| サービス | iam |
| 重大度 | low |
| カテゴリ | Uncategorized |
...
Ensure IAM policies that allow full "*:*" administrative privileges are not created, may be eventual consistent if an ephemeral resource is using it
...
- Source Metadata：[sources/aws/iam_customer_unattached_policy_no_administrative_privileges/metadata.json](../../sources/aws/iam_customer_unattached_policy_no_administrative_privileges/metadata.json)
- Source Code：[sources/aws/iam_customer_unattached_policy_no_administrative_privileges/check.py](../../sources/aws/iam_customer_unattached_policy_no_administrative_privileges/check.py)
- Source Metadata Path：`sources/aws/iam_customer_unattached_policy_no_administrative_privileges/metadata.json`
- Source Code Path：`sources/aws/iam_customer_unattached_policy_no_administrative_privileges/check.py`
