...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `rds_instance_default_admin` |
| 云平台 | AWS |
| 服务 | rds |
| 严重等级 | medium |
| 类别 | Uncategorized |
...
- 推荐链接：[https://docs.aws.amazon.com/securityhub/latest/userguide/rds-controls.html#rds-25](https://docs.aws.amazon.com/securityhub/latest/userguide/rds-controls.html#rds-25)
