...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `cloudtrail_logs_s3_bucket_is_not_publicly_accessible` |
| 云平台 | AWS |
| 服务 | cloudtrail |
| 严重等级 | critical |
| 类别 | internet-exposed |
| 检查类型 | Software and Configuration Checks/AWS Security Best Practices/Network Reachability, Industry and Regulatory Standards/AWS Foundational Security Best Practices, Industry and Regulatory Standards/CIS AWS Foundations Benchmark, Effects/Data Exposure |
| 资源类型 | AwsS3Bucket |
| 资源组 | storage |
