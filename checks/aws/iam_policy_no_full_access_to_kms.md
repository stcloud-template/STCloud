...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `iam_policy_no_full_access_to_kms` |
| クラウドプラットフォーム | AWS |
| サービス | iam |
| 重大度 | medium |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/aws/iam_policy_no_full_access_to_kms/metadata.json](../../sources/aws/iam_policy_no_full_access_to_kms/metadata.json)
- Source Code：[sources/aws/iam_policy_no_full_access_to_kms/check.py](../../sources/aws/iam_policy_no_full_access_to_kms/check.py)
- Source Metadata Path：`sources/aws/iam_policy_no_full_access_to_kms/metadata.json`
- Source Code Path：`sources/aws/iam_policy_no_full_access_to_kms/check.py`
