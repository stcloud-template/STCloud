# Ensure no IAM Inline policies allow actions that may lead into Privilege Escalation
...
- Source Metadata Path：`sources/aws/iam_inline_policy_allows_privilege_escalation/metadata.json`
- Source Code Path：`sources/aws/iam_inline_policy_allows_privilege_escalation/check.py`
