...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `iam_password_policy_number` |
| クラウドプラットフォーム | AWS |
| サービス | iam |
| 重大度 | medium |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/aws/iam_password_policy_number/metadata.json](../../sources/aws/iam_password_policy_number/metadata.json)
- Source Code：[sources/aws/iam_password_policy_number/check.py](../../sources/aws/iam_password_policy_number/check.py)
- Source Metadata Path：`sources/aws/iam_password_policy_number/metadata.json`
- Source Code Path：`sources/aws/iam_password_policy_number/check.py`
