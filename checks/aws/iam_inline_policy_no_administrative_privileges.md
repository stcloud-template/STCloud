...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `iam_inline_policy_no_administrative_privileges` |
| クラウドプラットフォーム | AWS |
| サービス | iam |
| 重大度 | high |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/aws/iam_inline_policy_no_administrative_privileges/metadata.json](../../sources/aws/iam_inline_policy_no_administrative_privileges/metadata.json)
- Source Code：[sources/aws/iam_inline_policy_no_administrative_privileges/check.py](../../sources/aws/iam_inline_policy_no_administrative_privileges/check.py)
- Source Metadata Path：`sources/aws/iam_inline_policy_no_administrative_privileges/metadata.json`
- Source Code Path：`sources/aws/iam_inline_policy_no_administrative_privileges/check.py`
