...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `iam_user_console_access_unused` |
| クラウドプラットフォーム | AWS |
| サービス | iam |
| 重大度 | medium |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/aws/iam_user_console_access_unused/metadata.json](../../sources/aws/iam_user_console_access_unused/metadata.json)
- Source Code：[sources/aws/iam_user_console_access_unused/check.py](../../sources/aws/iam_user_console_access_unused/check.py)
- Source Metadata Path：`sources/aws/iam_user_console_access_unused/metadata.json`
- Source Code Path：`sources/aws/iam_user_console_access_unused/check.py`
