...
| 項目 | 値 |
| --- | --- |
| チェック項目 ID | `iam_password_policy_symbol` |
| クラウドプラットフォーム | AWS |
| サービス | iam |
| 重大度 | medium |
| カテゴリ | Uncategorized |
...
- Source Metadata：[sources/aws/iam_password_policy_symbol/metadata.json](../../sources/aws/iam_password_policy_symbol/metadata.json)
- Source Code：[sources/aws/iam_password_policy_symbol/check.py](../../sources/aws/iam_password_policy_symbol/check.py)
- Source Metadata Path：`sources/aws/iam_password_policy_symbol/metadata.json`
- Source Code Path：`sources/aws/iam_password_policy_symbol/check.py`
