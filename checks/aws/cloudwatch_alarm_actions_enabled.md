...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `cloudwatch_alarm_actions_enabled` |
| 云平台 | AWS |
| 服务 | cloudwatch |
| 严重等级 | high |
| 类别 | resilience |
| 检查类型 | Software and Configuration Checks/AWS Security Best Practices, Industry and Regulatory Standards/AWS Foundational Security Best Practices, TTPs/Defense Evasion |
