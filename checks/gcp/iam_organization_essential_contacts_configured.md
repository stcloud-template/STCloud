...
| 字段 | 内容 |
| --- | --- |
| 检查项 ID | `iam_organization_essential_contacts_configured` |
| 云平台 | GCP |
| 服务 | iam |
| 严重等级 | medium |
| 类别 | Uncategorized |
...
- 推荐链接：[https://cloud.google.com/resource-manager/docs/managing-notification-contacts](https://cloud.google.com/resource-manager/docs/managing-notification-contacts)
