...
resource "aws_iam_role_policy_attachment" "stcloud_scan_policy_attachment" {
  role       = aws_iam_role.stcloud_scan.name
  policy_arn = aws_iam_policy.stcloud_scan_policy.arn
}

resource "aws_iam_role_policy_attachment" "stcloud_scan_securityaudit_policy_attachment" {
  role       = aws_iam_role.stcloud_scan.name
...
module "s3_integration" {
  ...
  stcloud_scan_role_name = aws_iam_role.stcloud_scan.name
}
