...
variable "enable_s3_integration" {
  type        = bool
  description = "Enable S3 integration for storing ST Cloud scan reports."
  default     = false
}

variable "s3_integration_bucket_name" {
  type        = string
  description = "The S3 bucket name where ST Cloud will store scan reports for your cloud providers. Required if enable_s3_integration is true."
  default     = ""
